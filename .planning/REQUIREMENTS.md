...
- [ ] **FORM-01**: All inputs, labels, buttons, and focus states across all pages use consistent warm palette styles
- [ ] **FORM-02**: Flash messages display as rounded cards with a semantic icon (success/error) and auto-dismiss after a few seconds
- [ ] **FORM-03**: Import and export error messages include a clear description of what went wrong and a specific next step (e.g., "Lyrics not found — try pasting them manually")
