...
plan: 03
subsystem: ui
tags: [erb, tailwind, heroicons, empty-states]

# Dependency graph
requires:
  - phase: 07-01
    provides: test stubs for EMPTY-02 and EMPTY-03 requirements

provides:
  - EMPTY-02: musical-note icon + "Your arrangement will appear here" in deck editor arrangement else branch
  - EMPTY-03: musical-note icon + "Import a song above to build your library." in song library else branch

affects: [08-deck-editor]

# Tech tracking
tech-stack:
  added: []
  patterns: [Heroicons inline SVG with w-8 h-8 text-stone-300 for small empty state icons]
