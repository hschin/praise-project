...
plan: "04"
subsystem: auth
tags: [devise, tailwind, brand, ui]

# Dependency graph
requires:
  - phase: 07-01
    provides: "AUTH-01 failing tests pre-populated in registrations_controller_test.rb"
provides:
...
affects: [07-05, 08-deck-editor]

# Tech tracking
tech-stack:
  added: []
  patterns:
    - "Auth page card pattern: bg-white rounded-xl shadow-sm border border-stone-200 p-8 wraps form_for only; links partial stays outside"
    - "Wordmark on auth pages uses font-serif text-rose-700 matching nav wordmark established in Phase 5"
