...
plan: "03"
subsystem: ui
tags: [error-copy, tailwind, heroicons, erb, jobs, turbo]
...
tech-stack:
  added: []
  patterns:
    - "Heroicons SVG inline pattern for error/warning icons in ERB partials"
    - "broadcast_error passes a human-readable locked string; raw exceptions logged only via Rails.logger"
