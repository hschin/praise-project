...
ActiveRecord::Schema[8.1].define(version: 2026_04_17_055422) do
  ...
  create_table "decks", force: :cascade do |t|
    t.datetime "created_at", null: false
    t.date "date"
    t.integer "lines_per_slide", default: 4, null: false
    t.text "notes"
    t.boolean "show_pinyin", default: true, null: false
    t.bigint "theme_id"
    t.string "title"
    t.datetime "updated_at", null: false
  ...
  create_table "exports", force: :cascade do |t|
    ...
    t.index ["deck_id"], name: "index_exports_on_deck_id"
